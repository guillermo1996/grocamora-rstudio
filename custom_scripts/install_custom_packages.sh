...
R -q -e 'BiocManager::install(c("AnnotationHub", "SingleCellExperiment", "clusterProfiler", "EnsDb.Hsapiens.v86", "org.Hs.eg.db", "org.Mm.eg.db", "DirichletMultinomial", "fgsea", "KEGGgraph"), Ncpus = '$NCPUS')'
